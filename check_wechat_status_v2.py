    ...
    try:
        ...
        if 'item' in data:
            ...
            for item in data['item']:
                # 转换时间
                create_time = datetime.fromtimestamp(item['content']['create_time'])
                update_time = datetime.fromtimestamp(item['content']['update_time'])
                print(f"  标题: {item['content']['news_item'][0]['title']}")
